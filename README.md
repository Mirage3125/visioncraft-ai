...
1. 为什么使用服务端 Route Handler 隐藏 API Key。
2. 如何用统一 AI SDK 接口降低模型供应商切换成本。
3. 为什么增加演示降级模式，以及它如何提高作品展示稳定性。
4. 如何实现客户端历史记录、错误状态和生成过程反馈。
5. 后续可扩展 Supabase 登录、云端作品库、积分计费、敏感词审核和多模型对比。
